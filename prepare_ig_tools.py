...
class Params:
    path_to_grinder = ""
    path_to_igblast = "src/tools/igblast/"
...
def CheckForBinExistance(log):
    if os.path.exists(ig_tools_init.PathToBins.repertoire_evaluator_tool):
        log.info("* Tool bin/ig_tools/repertoire_evaluator was successfully installed")
    else:
        log.info("ERROR: Tool bin/ig_tools/repertoire_evaluator was not found")
        sys.exit(1)

    if os.path.exists(ig_tools_init.PathToBins.repertoire_comparer_tool):
        log.info("* Tool bin/ig_tools/repertoire_comparer was successfully installed")
    else:
        log.info("ERROR: Tool bin/ig_tools/repertoire_comparer was not found")
        sys.exit(1)
